...
# MCP SDK does not attempt to limit what files or folders your tools attempt to read! You must implement that check yourself. This is example of such limitation by defining utils function used in "convert_video" tool
